...
# train and test paths will be different for 4-class and 2-class datasets
TRAIN_DATA_PATH = '/content/preprocessed-splitted-data/train/4-class'
TEST_DATA_PATH = '/content/preprocessed-splitted-data/test/4-class'
